...
flname1 = strcat('fig7_',ent(1),'.mat');
flname2 = strcat('fig7_',ent(2),'.mat');
...
x = lon*radius*deg;
 ...
 fprintf('\n');
 disp('Saving data');
 field_names = ["dynamic change";"thermodynamic change";"total change";"P-E L75O75-L75O100"];
 save('fig7.mat','wv_struct','lon','lat','field_names','unit')
