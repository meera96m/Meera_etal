...
%---------------------------------------------
 ...
 fprintf('\n');
 disp('Saving data');
  var_names = ["LW Temp tendency L100O100";"SW Temp tendency L100O100";"Conv Temp tendency L100O100";"LS Temp tendency L100O100";"BL Temp tendency L100O100";"omega L100O100";"Temp L100O100"];
save('fig10_L100O100.mat','tdt_lw','tdt_sw','tdt_conv','tdt_ls','tdt_bl','omega1','temp1','lon','lat','pres','var_names','units')
