...
x = lon*radius*deg;
 ...
 %thermodynamic change
  ...
  q_ch = sp1(:,:,1)-sp2(:,:,1);
  q_ch = q_ch*1000; %convert from kg/kg to g/kg

  dyn_ch = dyn_ch*10;
  therm_ch = therm_ch*10;
 ...
 units = ["*10^-1 mm/day";"*10^-1 mm/day";"g/kg"];

 fprintf('\n');
 disp('Saving data');
 field_names = ["dynamic change L75O100-L100O100";"thermodynamic change L75O100-L100O100";"q 996hPa L75O100-L100O100"];
 save('fig4.mat','wv_struct','lon','lat','field_names','units')
