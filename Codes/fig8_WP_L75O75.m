...
flname1 = strcat('/home/mmohan/projects/ctb-tmerlis/mmohan/Data/test_lofactor/',ent(3),'/1981jan01h00.atmos_month.nc');

lat = ncread(flname1,'grid_yt'); %latitude
lon = ncread(flname1,'grid_xt'); %longitude
pres = ncread(flname1,'pfull'); %pressure

path1 =strcat('/home/mmohan/projects/ctb-tmerlis/mmohan/Data/test_lofactor/',ent(3),'/');
 ...
 cpr1    = zeros(240,3,3);%conv precip L75O75
...
for jj =1:12
   for ii=1:length(year)
     ...
     cpr1(cc,:,:) = double(ncread(flname,varname1,[239,183,jj],[3,3,1]));
     cc = cc+1;
   end
 end
...
%---------------------------------------------
 ...
 fprintf('\n');
 disp('Saving data');
  var_names = ["convective precipitation L75O75";"surface height L75O75";"surface pressure L75O75";"surface temperature L75O75";"reference sphum L75O75";"sphum L75O75";"temperature L75O75"];
save('fig8_WP_L75O75.mat','cpr1','zs1','ps1','tsurf1','qref1','q1','t1','lon','lat','pres','var_names','units')
