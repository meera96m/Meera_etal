...
path1 =strcat('/home/mmohan/projects/ctb-tmerlis/mmohan/Data/test_lofactor/',ent(2),'/');
 ...
 cpr1    = zeros(240,3,3);%conv precip L100O100
...
for jj =1:12
   for ii=1:length(year)
     ...
     pc1(cc,:,:) = double(ncread(flname,varname1,[449,165,jj],[3,3,1]));
     cc = cc+1;
   end
 end
...
%---------------------------------------------
 ...
 fprintf('\n');
 disp('Saving data');
  var_names = ["convective precipitation L100O100";"surface height L100O100";"surface pressure L100O100";"surface temperature L100O100";"reference sphum L100O100";"sphum L100O100";"temperature L100O100"];
save('fig6_Amz_L100O100.mat','cpr1','zs1','ps1','tsurf1','qref1','q1','t1','lon','lat','pres','var_names','units')
