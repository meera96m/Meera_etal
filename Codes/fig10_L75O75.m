...
%---------------------------------------------
 ...
 fprintf('\n');
 disp('Saving data');
  var_names = ["LW Temp tendency L75O75";"SW Temp tendency L75O75";"Conv Temp tendency L75O75";"LS Temp tendency L75O75";"BL Temp tendency L75O75";"omega L75O75";"Temp L75O75"];
save('fig10_L75O75.mat','tdt_lw','tdt_sw','tdt_conv','tdt_ls','tdt_bl','omega1','temp1','lon','lat','pres','var_names','units')
